...
| `Nghệ Thuật Chuyển Đổi Tư Duy Viết Nội Dung Marketing Chuẩn Toàn Diện.docx` | DOCX | Minimalist Content Writing; Mindset | Read / Ingested (Batch 4B-1) | `01-core-principles/content-marketing-mindset.md` | Primary source for Content Minimalism Upgrade. Merged into Mindset framework to avoid duplication. |
...
| `Nghệ Thuật Bố Cục Tổng Phân Hợp Trong Content Marketing C1 - 3D.docx` | DOCX | Bố cục Tổng Phân Hợp | Read / Ingested (Batch 3A-3I-1E) | `02-frameworks/content-layout-systems/01-core-layouts/tong-phan-hop-layout.md` | Primary source. Extracted & integrated T.P.H Comprehensive Persuasion framework and logic sequencing. |
| `Bố cục Móc xích_ Nghệ thuật Thôi miên và Dẫn dắt Logic C1 - 3E.docx` | DOCX | Bố cục Móc xích | Read / Ingested (Batch 3A-3I-1F) | `02-frameworks/content-layout-systems/01-core-layouts/moc-xich-layout.md` | Primary source. Extracted & integrated Chain-Link Logic Framework and logic sequencing. |
| `Nghệ Thuật Bố Cục Đồng Tâm Trong Content Marketing C1 - 3F.docx` | DOCX | Bố cục Đồng tâm | Read / Ingested (Batch 3A-3I-1G) | `02-frameworks/content-layout-systems/01-core-layouts/dong-tam-layout.md` | Primary source. Extracted & integrated Concentric Surround Model framework and logic sequencing. |
| `Nghệ Thuật Mix Bố Cục Vấn Đề - Giải Pháp Đa Tầng C1 - 3G.docx` | DOCX | Bố cục Vấn đề - Giải pháp | Read / Ingested (Batch 3A-3I-1H) | `02-frameworks/content-layout-systems/01-core-layouts/van-de-giai-phap-layout.md` | Primary source. Extracted & integrated P.A.S Hybrid Model framework and layout mixing. |
