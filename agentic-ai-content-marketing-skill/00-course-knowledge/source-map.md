...
|---|---|---|---|---|---|
| `Nghệ thuật Bố cục Quy nạp và Dẫn dắt Content Thuyết phục.pdf` | PDF | Quy nạp; dẫn dắt thuyết phục | Read | `02-frameworks/content-layout-systems/quy-nap-layout.md`; `dan-dat-thuyet-phuc-layout.md` | Primary source used. |
...
| `Nghệ thuật Bố cục Tổng Phân Hợp trong Sáng tạo Nội dung.pdf` | PDF | Tổng phân hợp; partial diễn dịch comparison | Read | `02-frameworks/content-layout-systems/tong-phan-hop-layout.md`; `dien-dich-layout.md` | Used for Tổng - Phân - Hợp and limited source basis for diễn dịch. |
| `Nghệ thuật Sáng tạo Nội dung theo Bố cục Móc xích.pdf` | PDF | Móc xích | Read | `02-frameworks/content-layout-systems/moc-xich-layout.md` | Primary source used. |
| `Nghệ Thuật Làm Chủ Bố Cục Liệt Kê Trong Content Marketing.pdf` | PDF | Liệt kê | Read | `02-frameworks/content-layout-systems/liet-ke-layout.md` | Primary source used. |
| `Nghệ Thuật Bố Cục Và Quy Trình Xây Dựng Nội Dung Chi Tiết.pdf` | PDF | Quy trình xây dựng nội dung chi tiết; bố cục gốc overview | Read | `02-frameworks/content-layout-systems/detailed-content-process-layout.md`; `professional-content-marketing-layout.md`; `dien-dich-layout.md` | Used for meta-process and source confirmation that diễn dịch is a listed bố cục gốc. |
| `Nghệ Thuật Xây Dựng Bố Cục Content Marketing Chuyên Nghiệp.pdf` | PDF | Professional content marketing layout; bố cục gốc overview | Read | `02-frameworks/content-layout-systems/professional-content-marketing-layout.md`; `detailed-content-process-layout.md`; `dien-dich-layout.md` | Used for professional meta-framework and layout-system boundaries. |
...
| `Nghệ Thuật Xây Dựng Bố Cục Nội Dung Marketing Chuẩn Xu Hướng.docx` | DOCX | Marketing outline 5 phần | Partially read | Not targeted in Batch 2B | Related to Marketing outline 5 phần, not original layout systems. |
| `Nghệ Thuật Chuyển Đổi Tư Duy Viết Nội Dung Marketing Chuẩn Toàn Diện.docx` | DOCX | Marketing outline 5 phần; mindset | Partially read | Not targeted in Batch 2B | Related to mindset and Marketing outline 5 phần, not original layout systems. |
